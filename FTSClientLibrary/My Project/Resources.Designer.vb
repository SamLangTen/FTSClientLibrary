...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        '''<summary>
        '''  查找类似 This Account reference has been logined. 的本地化字符串。
        '''</summary>
        Friend ReadOnly Property UserException_HasLogined() As String
            Get
                Return ResourceManager.GetString("UserException_HasLogined", resourceCulture)
            End Get
        End Property
        
        '''<summary>
        '''  查找类似 This Account reference hasn&apos;t been logined. 的本地化字符串。
        '''</summary>
